				...
				<div class="fomrinter">
					<h4 class="formheading">Domestic</h4>
						<div id="formscroll">
							...
							<form action="domestic.php" method="post">
								<b style="color:white;">Location</b><br>
								...
								<b style="color:white;">Outbound</b><br>
								<input type="date" name="date" id="boxd2"><br><br>
								<b style="color:white;">Adults</b><br>
								<input type="text" name="adult" id="boxd3"><br><br>
								<b style="color:white;">Children</b><br>
